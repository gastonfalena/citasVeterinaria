//Obtenemos el id, luego creamos los events listeners con input,el objt citaObj coincide con los name del html, luego se llena con datos cita
...
class UI {
  imprimirAlerta(mensaje, tipo) {
    ...
    //agergra clase enm base al tipo de error
    if (tipo === 'error') {
